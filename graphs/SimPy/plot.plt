...
plot 'logs/8K_4K-client.log' using 1:xtic(2) ls 1 title '8K-4K', \
     'logs/8K_1K-client.log' using 1:xtic(2) ls 2  title '8K-1K', \
...
plot 'logs/8K_4K-server.log' using 1:xtic(2) ls 1  title '8K-4K', \
     'logs/8K_1K-server.log' using 1:xtic(2) ls 2  title '8K-1K'
...
plot 'logs/8K_4K-manager.log' using 1:xtic(2) ls 1 title '8K-4K', \
     'logs/8K_1K-manager.log' using 1:xtic(2) ls 2 title '8K-1K' 

set title 'Objects count'
set output "objects.svg"
set terminal svg enhanced size 1200,600 fname 'Sans' fsize 16
plot 'logs/8K_4K-objects.log' using 1:xtic(2) ls 1 title '8K-4K', \
     'logs/8K_1K-objects.log' using 1:xtic(2) ls 2 title '8K-1K' 
